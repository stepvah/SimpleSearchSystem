...
void TestManyQueries() {
    ...
    const vector<string> base_queries = {
      "we need some help",
      "it",
      "i love this game",
      "tell me why",
    ...
    for (int i = 0; i < 10000; ++i) {
        for (const auto& var : base_queries) {
...
int main()
{
    ...
    {
        LOG_DURATION("Many add queries:");
        RUN_TEST(tr, TestLongBuild);
    }
    {
        LOG_DURATION("Many queries:");
        RUN_TEST(tr, TestManyQueries);
    }
